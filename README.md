...
Exclusing the GaussianNB classifier, the other classifiers offered a lot of parameters to tune — with varying levels of impact on accuracy.
...
# Selected Classifier
The `DecisionTreeClassifier (RobustScaler + PCA)` was selected as the best classifier, because it predicted the data quickly and tied for the highest F1 Score.
